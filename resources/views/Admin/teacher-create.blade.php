...
@endif
    <div class="card-body">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>Teacher Name</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="teacherName"
                    placeholder="Enter Name" required/>
            </div>
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>Teacher Address</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="teacherAddress"
                    placeholder="Enter  Address" required/>
            </div>
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>NIC</label>
        ...
        <div class="form-row">
        <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span></span>Gender</label>
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>Teacher Level</label>
       ...
       <div class="form-row">
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>Teacher Image</label>
                <input type="file" class="form-control" id="image" name="teacher_image" placeholder="Teacher Image" required>
                <br>
                <img id="teacher_image" name="teacher_image" class="rounded-circle" height="100" width="100" src="#">
            </div>
            <div class="col-md-4 mb-4">
                <label for="formGroupExampleInput" class="form-label"><span style="color: red">*</span>Educational Qualification</label>
                <textarea class="form-control" id="formGroupExampleInput" name="educationQuali" rows="4" cols="50" required>
                </textarea>
            </div>
            <div class="col-md-4 mb-4">
