...
@endif 
        ...
        @csrf
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    <label for="formGroupExampleInput" class="form-label">Function</label>
                    <select class="form-control" id="formGroupExampleInput" name="function" placeholder="Select Function" >
                            <option value="Trip" >Trip</option>
                            <option value="Concert" >Concert</option>
                            <option value="Sportsmeet" >Sportsmeet</option>    
                            <option value="New Year Festival" >New Year Festival</option> 
                        </select>
                </div>
                <div class="col-md-3 mb-3">
            ...
            <input type="hidden" class="form-control" id="formGroupExampleInput" name="paymentType" value="Function">
            <div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @foreach($studentPayments as $key=>$studentPayment)
                            <tr>
                                ...
                                <td>{{$studentPayment->function}}</td>
                                <td>{{$studentPayment->amount}}</td>
                                <td>

                                <!-- <a href="{{ url('/g_invoice', $studentPayment->id) }}" class="btn btn-primary">Generate Invoice </a> -->
