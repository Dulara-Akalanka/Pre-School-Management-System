                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="capture_{{$student->s_id}}">
                                        <center>
                                        <p style="margin-bottom: 10px;"><strong>Student Barcode: {!! DNS1D::getBarcodeHTML($student->s_id, 'C128'); !!}</strong></p>
                                        </center>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button class="btn btn-success" onclick="captureDivAsImage('{{$student->s_id}}')">Download</button>
                                    </div>
                                </div>
                            </div>
                        </div>
