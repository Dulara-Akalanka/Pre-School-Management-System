    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="primary-bg" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="{{route('s-teacher')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active">
                        <i class="fa fa-users" aria-hidden="true"></i> Teacher
                    </a>

                    <a href="{{route('s-student')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active">
                        <i class="fa fa-child" aria-hidden="true"></i> Student
                    </a>

                    <!-- <a href="{{route('s-payment')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active">
                        <i class="fa fa-child" aria-hidden="true"></i> Payments
                    </a> -->
                </div>
            </div>
